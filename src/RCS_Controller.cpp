...
void RCS_Controller::runRCS(double dt, Eigen::Vector3d idealThrustDirWorld, bool ignoreRoll, double rollSetpointDeg, Eigen::Vector3d desiredAttitudeEuler, bool directAttitudeControl) {
